...
class PaypalNativeCheckout {
  ...
  void setPayPalOrderCallback({required FPayPalOrderCallback callback}) {
    _callback = callback;
  }
  ...
  Future<PaypalNativeCheckout> init({
    ...
    Map<String, String> data = {
      ...
      "userAction": FPayPalUserActionHelper.convertFromEnumToString(action),
    };
    await _methodChannel.invokeMethod<String>('FlutterPaypal#initiate', data);
    return instance;
  }
  ...
  void _onPayPalOrderSuccess(Map<String, dynamic> data) {
    ...
    try {
      success = FPayPalApprovalData.fromJson(jsonDecode(aData));
    } catch (e) {
